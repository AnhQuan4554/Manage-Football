...
const attendance = (going: string[], absent: string[] = [], maybe: string[] = []) =>
  Object.fromEntries(
    mockMembers
      ...
      .map((member) => [
        member.id,
        going.includes(member.id)
          ? "going"
          : absent.includes(member.id)
            ? "absent"
            : maybe.includes(member.id)
              ? "maybe"
              : "unknown",
      ]),
  ) as Match["attendance"];
...
export const mockMatches: Match[] = [
  {
    id: "match-1",
    teamId: mockTeam.id,
    opponentName: "Hà Đông Legends",
    date: "2026-08-18",
    time: "19:30",
    pitch: "Sân Phạm Tu - sân số 2",
    address: "Ngõ 12 Phạm Tu, Hà Đông, Hà Nội",
    pitchCost: 700000,
    opponentFee: 200000,
    note: "Mang cả áo sáng và áo tối. Khởi động từ 19:10.",
    status: "scheduled",
    zaloVoteStatus: "created",
    formation: "2-3-1",
    attendance: attendance(["m1", "m2", "m3", "m4", "m5", "m6", "m9", "m10"], ["m7"], ["m8", "m11"]),
    lineup: { gk: "m9", d1: "m3", d2: "m5", m1: "m4", m2: "m2", m3: "m10", f1: "m1" },
  },
  {
    id: "match-2",
    teamId: mockTeam.id,
    opponentName: "FC Kiến Hưng",
    date: "2026-08-25",
    time: "19:00",
    pitch: "Sân Kiến Hưng - sân số 1",
    address: "Đường Kiến Hưng, Hà Đông, Hà Nội",
    pitchCost: 650000,
    opponentFee: 0,
    note: "Chưa tạo bình chọn Zalo.",
    status: "scheduled",
    zaloVoteStatus: "none",
    formation: "3-2-1",
    attendance: attendance(["m1", "m2", "m6"], [], ["m4"]),
    lineup: {},
  },
  {
    id: "match-3",
    teamId: mockTeam.id,
    opponentName: "Thanh Xuân FC",
    date: "2026-08-11",
    time: "19:30",
    pitch: "Sân Phạm Tu - sân số 1",
    address: "Ngõ 12 Phạm Tu, Hà Đông, Hà Nội",
    pitchCost: 700000,
    opponentFee: 150000,
    note: "Thủng lưới phút cuối, cần chốt đội hình sớm hơn.",
    status: "completed",
    zaloVoteStatus: "created",
    formation: "2-3-1",
